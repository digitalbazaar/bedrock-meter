 ...
 *
 * @returns {Promise<boolean>} `true` on update success.
 */
 ...
 *
 * @param {object} options - Options to use.
 * @param {object} options - The meter to update.
 * @param {object} options.newUsage - The new usage to report.
 * @param {number} options.newUsage.storage - The new current total storage for
 *   the meter.
 * @param {number} options.newUsage.operations - The new additional operations
 *   to add to the meter.
 *
 * @returns {Promise<object>} The meter record.
 */
